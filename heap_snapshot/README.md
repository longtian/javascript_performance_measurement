...
2\. `nodes` 保存了是所有结点的 id，name，大小信息等,对应 v8 源码里的 [`HeapGraphNode`](https://github.com/joyent/node/blob/master/deps/v8/include/v8-profiler.h#L219)
...
edges[ edge_offset +2 ]   是 Edge 指向的对象的结点类型在 `nodes` 里的索引
```
